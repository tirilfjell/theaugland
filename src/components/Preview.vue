              ...
              <div class="w-full grid grid-cols-1 gap-y-8 gap-x-6 items-start sm:grid-cols-12 lg:gap-x-8">
                <div class="sm:col-span-4 lg:col-span-5">
                  <div class="aspect-w-1 aspect-h-1 rounded-lg bg-gray-100 overflow-hidden">
                    <img :src="product.imageSrc" :alt="product.imageAlt" class="object-center object-contain" />
                  </div>
                </div>
                <div class="sm:col-span-8 lg:col-span-7">
                  ...
                  <section aria-labelledby="options-heading" class="mt-6">
                    <div class="mt-6">
                      ...
                      >
                        <a :href="product.href" class="font-medium text-white">Link</a>
                      </button>
                    </div>
                    <p class="absolute top-4 left-4 text-center sm:static sm:mt-6"></p>
                  </section>
                </div>
              </div>
            </div>
...
const product = {
  ...
  imageSrc: require("../assets/app.png"),
